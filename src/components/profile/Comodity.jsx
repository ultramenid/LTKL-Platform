...
const COMMODITY_PRODUCTION = [
  {
    name: 'Kakao',
    color: '#92400e',
    data: [12400, 13100, 13800, 11200, 14200, 15100, 15800, 16900, 17800, 18600, 19500],
  },
  {
    name: 'Padi',
    color: COLORS.PRIMARY,
    data: [98000, 102000, 107000, 89000, 110000, 114000, 118000, 123000, 128000, 133000, 138000],
  },
  {
    name: 'Jagung',
    color: '#f59e0b',
    data: [34000, 36500, 39000, 31000, 41000, 43500, 46000, 49000, 52000, 55000, 58000],
  },
  {
    name: 'Kopi',
    color: '#78350f',
    data: [4200, 4600, 5000, 4100, 5300, 5700, 6100, 6600, 7100, 7600, 8100],
  },
  {
    name: 'Kelapa',
    color: '#65a30d',
    data: [8900, 9400, 9900, 8200, 10400, 11000, 11600, 12300, 13000, 13700, 14400],
  },
];
...
const HARVEST_AREA = [
  {
    name: 'Kakao',
    color: '#92400e',
    data: [5200, 5400, 5600, 4800, 5900, 6200, 6500, 6900, 7200, 7600, 7900],
  },
  {
    name: 'Padi',
    color: COLORS.PRIMARY,
    data: [18000, 18800, 19500, 16500, 20200, 21000, 21800, 22700, 23600, 24500, 25400],
  },
  {
    name: 'Jagung',
    color: '#f59e0b',
    data: [8500, 9000, 9600, 7800, 10200, 10800, 11400, 12100, 12800, 13500, 14200],
  },
  {
    name: 'Kopi',
    color: '#78350f',
    data: [2100, 2200, 2400, 2000, 2500, 2700, 2900, 3100, 3300, 3500, 3700],
  },
  {
    name: 'Kelapa',
    color: '#65a30d',
    data: [3800, 3950, 4100, 3600, 4300, 4500, 4700, 4950, 5200, 5450, 5700],
  },
];
