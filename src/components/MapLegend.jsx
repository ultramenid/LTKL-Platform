...
const LULC_LEGEND = [
  ...
  },
  {
    ...
    color: "#d6bc74",
    children: [
      { code: 13, nameEn: "Non-Forest Natural Vegetation", nameId: "Tumbuhan Non-Hutan Lainnya", color: "#d89f5c" },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    children: [
      ...
      { code: 25, nameEn: "Other Non-Vegetation",  nameId: "Non-Vegetasi Lainnya", color: "#db4d4f" },
    ],
  },
  {
    id: 5,
    ...
    <div className="relative z-10">
      ...
      {!expanded && (
        ...
        >
          ...
          <span className="text-xs font-black text-white/80">Legend</span>
        </button>
      )}
